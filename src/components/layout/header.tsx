...
export function Header({
  ...
  return (
    <header
      className={
        fixed
          ? "bg-surface-container border-b border-outline-variant fixed top-0 w-full z-50"
          : "bg-surface-container border-b border-outline-variant sticky top-0 z-50"
      }
    >
      <div className="relative flex justify-between items-center w-full px-margin-desktop h-14 md:h-16 max-w-container-max mx-auto gap-2 md:gap-4">
